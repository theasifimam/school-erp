...
import { AttendanceTrendChart } from "./AttendanceTrendChart"; // You'd need to create this
      ...
      >
        ...
        <TabsContent value="daily">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-6 gap-4 bg-white p-3 rounded-xl shadow-sm">
              {/* Date + Controls */}
